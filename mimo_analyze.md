...
### 1. ASR 重置检测逻辑有缺陷 (`matcher.js:109-118`)
...
### 2. `calculateSimilarity` 太简单 (`matcher.js:161-169`)
...
### 3. `tick()` 是空操作，时间推进机制未生效 (`matcher.js:244-247`)
...
### 4. Fallback 匹配将全文当作 delta 传入 (`prompter.js:457-460`)
...
### 6. 仅向前滚动，无法纠正过度推进 (`prompter.js:361-366`)
